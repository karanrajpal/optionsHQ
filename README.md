...
## TODOs
1. In watchlist items page, enrich the data with standard Alpaca types instead of using custom types.
2. Replace ClosePrice with LatestTrade Price across the app wherever applicable.